...
# -----------------------------------------------------
INPUT_DIR = os.path.join(BASE_DIR, "DoorSlam")
OUTPUT_NOISE = os.path.join(BASE_DIR, "DoorSlam_yes")
OUTPUT_BG = os.path.join(BASE_DIR, "DoormSlam_background")
...
for file in tqdm(os.listdir(INPUT_DIR)):
    # Accept WAV, MP3, FLAC, M4A, OGG, etc.
